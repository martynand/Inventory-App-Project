package com.example.martyna.scholarshipproject_inventoryapp;
...
import com.example.martyna.scholarshipproject_inventoryapp.data.ProductContract.ProductEntry;
...
public class DetailActivity extends AppCompatActivity implements
    ...
    private static final String FILE_PROVIDER_AUTHORITY = "com.example.martyna.scholarshipproject_inventoryapp.data.ProductContract.ProductEntry";
        ...
        orderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checkForName() && checkForQuantity()) {
                    ...
                    Toast.makeText(DetailActivity.this, "You have to insert product name and quantity to send order.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        plusButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!checkForQuantityChanger() || !checkForQuantity()) {
                    Toast.makeText(DetailActivity.this, "Insert both: quantity and quantity changer.", Toast.LENGTH_SHORT).show();
                } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_save:
                if (!checkForName()) {
                    Toast.makeText(this, "Insert product name.", Toast.LENGTH_SHORT).show();
                } else if (!checkForQuantityChanger()) {
                    Toast.makeText(this, "Insert valid quantity changer.", Toast.LENGTH_SHORT).show();
                } else {
                    saveProduct();
                    finish();
                }
